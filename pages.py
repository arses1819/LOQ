...
<aside class="side-panel" id="panel" aria-hidden="true">
  ...
  <div class="panel-head"><span class="bar"></span><span class="mono">ARSES · CONTROL PANEL</span></div>
...
.sdev-card{display:none!important;display:flex;align-items:center;gap:12px;padding:12px 14px;border-radius:14px;background:var(--card-in);border:1px solid var(--border);text-decoration:none;transition:all .2s cubic-bezier(.4,0,.2,1)}
...
/* ═════ ARSES CYBERPUNK SKIN ═════ */
:root{
  --bg:#050713;--bg2:#090b1a;--bg3:#11142a;
  --card:rgba(13,16,35,.82);--card-b:rgba(118,92,255,.20);--card-bh:rgba(46,214,255,.55);
  --accent:#7c5cff;--accent2:#39d8ff;--accent-d:rgba(124,92,255,.14);
  --green:#21e6a5;--green-bg:rgba(33,230,165,.10);--green-t:#67f5c5;
  --red:#ff5577;--red-bg:rgba(255,85,119,.10);--red-t:#ff8da5;
  --amber:#ffc857;--amber-bg:rgba(255,200,87,.10);--amber-t:#ffe09a;
  --purple:#d26bff;--purple-bg:rgba(210,107,255,.11);
  --t1:#f4f1ff;--t2:#a9a8c8;--t3:#686887;--sidebar-w:250px;--radius:16px;
  --shadow:0 14px 50px rgba(0,0,0,.42),0 0 35px rgba(124,92,255,.06)
}
body{background:radial-gradient(circle at 78% 8%,rgba(124,92,255,.12),transparent 28%),radial-gradient(circle at 15% 80%,rgba(57,216,255,.07),transparent 25%),var(--bg);}
body::before{content:"";position:fixed;inset:0;pointer-events:none;z-index:-1;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:42px 42px;mask-image:radial-gradient(circle at 55% 35%,#000,transparent 78%)}
.sidebar{background:linear-gradient(180deg,rgba(8,10,24,.97),rgba(6,7,17,.97));border-left:1px solid rgba(124,92,255,.28);box-shadow:-12px 0 45px rgba(0,0,0,.24)}
.logo{padding:20px 16px 18px;border-bottom-color:rgba(124,92,255,.20)}
.logo-img{border-color:rgba(57,216,255,.4);box-shadow:0 0 22px rgba(57,216,255,.18),0 0 30px rgba(124,92,255,.12)}
.logo-name{font-size:15px;letter-spacing:.03em;text-shadow:0 0 18px rgba(57,216,255,.35)}
.logo-sub{color:#72739a}
.nav-sec{color:#66668c}
.nav-it{border-radius:10px;margin:3px 7px;border-right-width:2px}
.nav-it:hover{background:linear-gradient(90deg,rgba(124,92,255,.12),rgba(57,216,255,.04));color:#d7d5f4}
.nav-it.on{background:linear-gradient(90deg,rgba(124,92,255,.18),rgba(57,216,255,.06));border-right-color:#39d8ff;box-shadow:inset 0 0 22px rgba(124,92,255,.05),0 0 18px rgba(57,216,255,.04)}
.nav-it.on i{color:#39d8ff;text-shadow:0 0 12px rgba(57,216,255,.7)}
.main{padding-top:30px}
.topbar{padding:2px 2px 8px}
.tb-title{text-shadow:0 0 22px rgba(124,92,255,.22)}
.tb-title i{color:#39d8ff;text-shadow:0 0 14px rgba(57,216,255,.6)}
.metric,.traf-mini,.traf-chart-card,.sysres-card,.card,.table-wrap,.modal-v2,.modal-v2-body,.modal-v2-head{background:linear-gradient(145deg,rgba(16,19,43,.88),rgba(8,10,25,.92));backdrop-filter:blur(12px);border-color:rgba(124,92,255,.20);box-shadow:0 10px 34px rgba(0,0,0,.20)}
.metric:hover,.traf-mini:hover{border-color:rgba(57,216,255,.48);box-shadow:0 12px 35px rgba(0,0,0,.30),0 0 24px rgba(57,216,255,.07)}
.metric::after{background:linear-gradient(#39d8ff,#7c5cff);box-shadow:0 0 12px #39d8ff}
.btn-p,.btn-primary,.cm-btn-submit,.btn{background:linear-gradient(135deg,#7c5cff,#3b9dff)!important;box-shadow:0 8px 24px rgba(124,92,255,.24),0 0 18px rgba(57,216,255,.08)!important}
.btn-p:hover,.btn-primary:hover,.cm-btn-submit:hover,.btn:hover{filter:brightness(1.08) saturate(1.12);box-shadow:0 12px 32px rgba(124,92,255,.32),0 0 25px rgba(57,216,255,.12)!important}
input,select,textarea{background:rgba(4,6,17,.65)!important;border-color:rgba(124,92,255,.22)!important;color:var(--t1)!important}
input:focus,select:focus,textarea:focus{border-color:#39d8ff!important;box-shadow:0 0 0 3px rgba(57,216,255,.08),0 0 20px rgba(57,216,255,.08)!important}
.badge.bg-blue{background:rgba(57,216,255,.10);color:#63e2ff;border:1px solid rgba(57,216,255,.18)}
.badge.bg-purple{background:rgba(210,107,255,.10);color:#e29aff;border:1px solid rgba(210,107,255,.18)}
.theme-btn,.menu-btn,.theme-mob{border-color:rgba(124,92,255,.22)}
.table th{color:#7d7ca2}
.table td{border-bottom-color:rgba(124,92,255,.09)}
.modal-bg{backdrop-filter:blur(8px);background:rgba(2,3,10,.72)}
.modal-v2{border-color:rgba(124,92,255,.32)!important;box-shadow:0 25px 80px rgba(0,0,0,.55),0 0 40px rgba(124,92,255,.08)!important}
/* anime/cyberpunk accent strip */
.main::before{content:"ARSΞS";position:fixed;left:22px;bottom:14px;font-family:monospace;font-size:9px;letter-spacing:.35em;color:rgba(57,216,255,.22);pointer-events:none}
@media(max-width:640px){.main{padding:68px 14px 45px}.main::before{display:none}}
...
<div class="modal-bg" id="modal-support-dev" style="display:none" style="z-index:9999">
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">Arses</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">Arses</div><div class="logo-sub">Arses Panel</div></div>
  </div>
  <div class="nav-wrap">
  ...
  <div class="sb-foot">
    ...
    <a class="tg-btn" style="display:none" href="https://t.me/CodeBoxo" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i> @CodeBoxo</a>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Arses Panel · Control Center</span>
    ...
    <div class="node-hero-top">
      <div class="node-hero-title">
        ...
        <div>
          ...
          <div class="tb-sub">مدیریت متمرکز کانفیگ‌ها، کاربران و مصرف سرورها</div>
        </div>
      </div>
      <div class="tb-right">
...
<title>Arses Subscription</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      ...
      <div><div class="brand-name">Arses</div><div class="brand-sub">Arses Panel</div></div>
    </div>
  ...
  <div class="footer">Arses Panel · Subscription</div>
</div>
<script>
